...
const trouver: Verb = {
  name: "trouver",
  conjugations: {
    "indicatif présent": { "je": "trouve", "tu": "trouves", "il/elle": "trouve", "nous": "trouvons", "vous": "trouvez", "ils/elles": "trouvent" },
    "indicatif imparfait": { "je": "trouvais", "tu": "trouvais", "il/elle": "trouvait", "nous": "trouvions", "vous": "trouviez", "ils/elles": "trouvaient" },
    "indicatif passé simple": { "je": "trouvai", "tu": "trouvas", "il/elle": "trouva", "nous": "trouvâmes", "vous": "trouvâtes", "ils/elles": "trouvèrent" },
    "indicatif futur simple": { "je": "trouverai", "tu": "trouveras", "il/elle": "trouvera", "nous": "trouverons", "vous": "trouverez", "ils/elles": "trouveront" },
    "indicatif passé composé": { "je": "ai trouvé", "tu": "as trouvé", "il/elle": "a trouvé", "nous": "avons trouvé", "vous": "avez trouvé", "ils/elles": "ont trouvé" },
    "indicatif plus-que-parfait": { "je": "avais trouvé", "tu": "avais trouvé", "il/elle": "avait trouvé", "nous": "avions trouvé", "vous": "aviez trouvé", "ils/elles": "avaient trouvé" },
    "indicatif passé antérieur": { "je": "eus trouvé", "tu": "eus trouvé", "il/elle": "eut trouvé", "nous": "eûmes trouvé", "vous": "eûtes trouvé", "ils/elles": "eurent trouvé" },
    "indicatif futur antérieur": { "je": "aurai trouvé", "tu": "auras trouvé", "il/elle": "aura trouvé", "nous": "aurons trouvé", "vous": "aurez trouvé", "ils/elles": "auront trouvé" },
    "subjonctif présent": { "je": "que je trouve", "tu": "que tu trouves", "il/elle": "qu'il trouve", "nous": "que nous trouvions", "vous": "que vous trouviez", "ils/elles": "qu'ils trouvent" },
    "subjonctif imparfait": { "je": "que je trouvasse", "tu": "que tu trouvasses", "il/elle": "qu'il trouvât", "nous": "que nous trouvassions", "vous": "que vous trouvassiez", "ils/elles": "qu'ils trouvassent" },
    "subjonctif passé": { "je": "que j'aie trouvé", "tu": "que tu aies trouvé", "il/elle": "qu'il ait trouvé", "nous": "que nous ayons trouvé", "vous": "que vous ayez trouvé", "ils/elles": "qu'ils aient trouvé" },
    "subjonctif plus-que-parfait": { "je": "que j'eusse trouvé", "tu": "que tu eusses trouvé", "il/elle": "qu'il eût trouvé", "nous": "que nous eussions trouvé", "vous": "que vous eussiez trouvé", "ils/elles": "qu'ils eussent trouvé" },
    ...
    "conditionnel passé première forme": { "je": "aurais trouvé", "tu": "aurais trouvé", "il/elle": "aurait trouvé", "nous": "aurions trouvé", "vous": "auriez trouvé", "ils/elles": "auraient trouvé" },
    "conditionnel passé deuxième forme": { "je": "eusse trouvé", "tu": "eusses trouvé", "il/elle": "eût trouvé", "nous": "eussions trouvé", "vous": "eussiez trouvé", "ils/elles": "eussent trouvé" },
    ...
    "gérondif présent": "en trouvant",
    "gérondif passé": "en ayant trouvé"
  }
};
...
const acheter: Verb = {
  name: "acheter",
  conjugations: {
    "indicatif présent": { "je": "achète", "tu": "achètes", "il/elle": "achète", "nous": "achetons", "vous": "achetez", "ils/elles": "achètent" },
    "indicatif imparfait": { "je": "achetais", "tu": "achetais", "il/elle": "achetait", "nous": "achetions", "vous": "achetiez", "ils/elles": "achetaient" },
    "indicatif passé simple": { "je": "achetai", "tu": "achetas", "il/elle": "acheta", "nous": "achetâmes", "vous": "achetâtes", "ils/elles": "achetèrent" },
    "indicatif futur simple": { "je": "achèterai", "tu": "achèteras", "il/elle": "achètera", "nous": "achèterons", "vous": "achèterez", "ils/elles": "achèteront" },
    "indicatif passé composé": { "je": "ai acheté", "tu": "as acheté", "il/elle": "a acheté", "nous": "avons acheté", "vous": "avez acheté", "ils/elles": "ont acheté" },
    "indicatif plus-que-parfait": { "je": "avais acheté", "tu": "avais acheté", "il/elle": "avait acheté", "nous": "avions acheté", "vous": "aviez acheté", "ils/elles": "avaient acheté" },
    "indicatif passé antérieur": { "je": "eus acheté", "tu": "eus acheté", "il/elle": "eut acheté", "nous": "eûmes acheté", "vous": "eûtes acheté", "ils/elles": "eurent acheté" },
    "indicatif futur antérieur": { "je": "aurai acheté", "tu": "auras acheté", "il/elle": "aura acheté", "nous": "aurons acheté", "vous": "aurez acheté", "ils/elles": "auront acheté" },
    "subjonctif présent": { "je": "que j'achète", "tu": "que tu achètes", "il/elle": "qu'il achète", "nous": "que nous achetions", "vous": "que vous achetiez", "ils/elles": "qu'ils achètent" },
    "subjonctif imparfait": { "je": "que j'achetasse", "tu": "que tu achetasses", "il/elle": "qu'il achetât", "nous": "que nous achetassions", "vous": "que vous achetassiez", "ils/elles": "qu'ils achetassent" },
    "subjonctif passé": { "je": "que j'aie acheté", "tu": "que tu aies acheté", "il/elle": "qu'il ait acheté", "nous": "que nous ayons acheté", "vous": "que vous ayez acheté", "ils/elles": "qu'ils aient acheté" },
    "subjonctif plus-que-parfait": { "je": "que j'eusse acheté", "tu": "que tu eusses acheté", "il/elle": "qu'il eût acheté", "nous": "que nous eussions acheté", "vous": "que vous eussiez acheté", "ils/elles": "qu'ils eussent acheté" },
    "conditionnel présent": { "je": "achèterais", "tu": "achèterais", "il/elle": "achèterait", "nous": "achèterions", "vous": "achèteriez", "ils/elles": "achèteraient" },
    "conditionnel passé première forme": { "je": "aurais acheté", "tu": "aurais acheté", "il/elle": "aurait acheté", "nous": "aurions acheté", "vous": "auriez acheté", "ils/elles": "auraient acheté" },
    "conditionnel passé deuxième forme": { "je": "eusse acheté", "tu": "eusses acheté", "il/elle": "eût acheté", "nous": "eussions acheté", "vous": "eussiez acheté", "ils/elles": "eussent acheté" },
    "impératif présent": { "tu": "achète", "nous": "achetons", "vous": "achetez" },
    "impératif passé": { "tu": "aie acheté", "nous": "ayons acheté", "vous": "ayez acheté" },
    "infinitif présent": "acheter",
    "infinitif passé": "avoir acheté",
    "participe présent": "achetant",
    "participe passé": "acheté",
    "gérondif présent": "en achetant",
    "gérondif passé": "en ayant acheté"
  }
};
...
const arriver: Verb = {
  ...
  conjugations: {
    ...
    "indicatif passé simple": { "je": "arrivai", "tu": "arrivas", "il/elle": "arriva", "nous": "arrivâmes", "vous": "arrivâtes", "ils/elles": "arrivèrent" },
    ...
    "subjonctif présent": { "je": "que j'arrive", "tu": "que tu arrives", "il/elle": "qu'il arrive", "nous": "que nous arrivions", "vous": "que vous arriviez", "ils/elles": "qu'ils arrivent" },
    "subjonctif imparfait": { "je": "que j'arrivasse", "tu": "que tu arrivasses", "il/elle": "qu'il arrivât", "nous": "que nous arrivassions", "vous": "que vous arrivassiez", "ils/elles": "qu'ils arrivassent" },
...
const vivre: Verb = {
  ...
  conjugations: {
    ...
    "indicatif passé simple": { "je": "vécus", "tu": "vécus", "il/elle": "vécut", "nous": "vécûmes", "vous": "vécûtes", "ils/elles": "vécurent" },
...
const travailler: Verb = {
  ...
  conjugations: {
    ...
    "indicatif passé simple": { "je": "travaillai", "tu": "travaillas", "il/elle": "travaille", "nous": "travaillâmes", "vous": "travaillâtes", "ils/elles": "travaillèrent" },
...
const étudier: Verb = {
  ...
  conjugations: {
    ...
    "indicatif passé simple": { "je": "étudiai", "tu": "étudias", "il/elle": "étudia", "nous": "étudiâmes", "vous": "étudiâtes", "ils/elles": "étudièrent" },
    ...
    "subjonctif présent": { "je": "que j'étudie", "tu": "que tu étudies", "il/elle": "qu'il étudie", "nous": "que nous étudions", "vous": "que vous étudiez", "ils/elles": "qu'ils étudient" },
    "subjonctif imparfait": { "je": "que j'étudiasse", "tu": "que tu étudiasses", "il/elle": "qu'il étudiât", "nous": "que nous étudiassions", "vous": "que vous étudiassiez", "ils/elles": "qu'ils étudiassent" },
