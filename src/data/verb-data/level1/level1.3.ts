...
const savoir: Verb = {
  ...
  conjugations: {
    ...
    "subjonctif imparfait": { "je": "que je susse", "tu": "que tu susses", "il/elle": "qu'il sût", "nous": "que nous sussions", "vous": "que vous sussiez", "ils/elles": "qu'ils sussent" },
...
const avouer: Verb = {
  ...
  conjugations: {
    ...
    "subjonctif présent": { "je": "que j'avoue", "tu": "que tu avoues", "il/elle": "qu'il avoue", "nous": "que nous avouions", "vous": "que vous avouiez", "ils/elles": "qu'ils avouent" },
    "subjonctif imparfait": { "je": "que j'avouasse", "tu": "que tu avouasses", "il/elle": "qu'il avouât", "nous": "que nous avouassions", "vous": "que vous avouassiez", "ils/elles": "qu'ils avouassent" },
...
const accepter: Verb = {
  ...
  conjugations: {
    ...
    "subjonctif présent": { "je": "que j'accepte", "tu": "que tu acceptes", "il/elle": "qu'il accepte", "nous": "que nous acceptions", "vous": "que vous acceptiez", "ils/elles": "qu'ils acceptent" },
    "subjonctif imparfait": { "je": "que j'acceptasse", "tu": "que tu acceptasses", "il/elle": "qu'il acceptât", "nous": "que nous acceptassions", "vous": "que vous acceptassiez", "ils/elles": "qu'ils acceptassent" },
...
const attendre: Verb = {
  ...
  conjugations: {
    ...
    "indicatif passé composé": { "je": "ai attendu", "tu": "as attendu", "il/elle": "a attendu", "nous": "avons attendu", "vous": "avez attendu", "ils/elles": "ont attendu" },
    ...
    "subjonctif présent": { "je": "que j'attende", "tu": "que tu attendes", "il/elle": "qu'il attende", "nous": "que nous attendions", "vous": "que vous attendiez", "ils/elles": "qu'ils attendent" },
    "subjonctif imparfait": { "je": "que j'attendisse", "tu": "que tu attendisses", "il/elle": "qu'il attendît", "nous": "que nous attendissions", "vous": "que vous attendissiez", "ils/elles": "qu'ils attendissent" },
...
const aider: Verb = {
  ...
  conjugations: {
    ...
    "subjonctif présent": { "je": "que j'aide", "tu": "que tu aides", "il/elle": "qu'il aide", "nous": "que nous aidions", "vous": "que vous aidiez", "ils/elles": "qu'ils aident" },
    "subjonctif imparfait": { "je": "que j'aidasse", "tu": "que tu aidasses", "il/elle": "qu'il aidât", "nous": "que nous aidassions", "vous": "que vous aidassiez", "ils/elles": "qu'ils aidassent" },
...
const amener: Verb = {
  ...
  conjugations: {
    ...
    "subjonctif présent": { "je": "que j'amène", "tu": "que tu amènes", "il/elle": "qu'il amène", "nous": "que nous amenions", "vous": "que vous ameniez", "ils/elles": "qu'ils amènent" },
    "subjonctif imparfait": { "je": "que j'amenasse", "tu": "que tu amenasses", "il/elle": "qu'il amenât", "nous": "que nous amenassions", "vous": "que vous amenassiez", "ils/elles": "qu'ils amenassent" },
...
const appeler: Verb = {
  ...
  conjugations: {
    ...
    "subjonctif présent": { "je": "que j'appelle", "tu": "que tu appelles", "il/elle": "qu'il appelle", "nous": "que nous appelions", "vous": "que vous appeliez", "ils/elles": "qu'ils appellent" },
    "subjonctif imparfait": { "je": "que j'appelasse", "tu": "que tu appelasses", "il/elle": "qu'il appelât", "nous": "que nous appelassions", "vous": "que vous appelassiez", "ils/elles": "qu'ils appelassent" },
...
const arriver: Verb = {
  ...
  conjugations: {
    ...
    "indicatif passé composé": { "je": "suis arrivé(e)", "tu": "es arrivé(e)", "il/elle": "est arrivé(e)", "nous": "sommes arrivé(e)s", "vous": "êtes arrivé(e)(s)", "ils/elles": "sont arrivé(e)s" },
    "indicatif plus-que-parfait": { "je": "étais arrivé(e)", "tu": "étais arrivé(e)", "il/elle": "était arrivé(e)", "nous": "étions arrivé(e)s", "vous": "étiez arrivé(e)(s)", "ils/elles": "étaient arrivé(e)s" },
    "indicatif passé antérieur": { "je": "fus arrivé(e)", "tu": "fus arrivé(e)", "il/elle": "fut arrivé(e)", "nous": "fûmes arrivé(e)s", "vous": "fûtes arrivé(e)(s)", "ils/elles": "furent arrivé(e)s" },
    "indicatif futur antérieur": { "je": "serai arrivé(e)", "tu": "seras arrivé(e)", "il/elle": "sera arrivé(e)", "nous": "serons arrivé(e)s", "vous": "serez arrivé(e)(s)", "ils/elles": "seront arrivé(e)s" },
    ...
    "subjonctif passé": { "je": "que je sois arrivé(e)", "tu": "que tu sois arrivé(e)", "il/elle": "qu'il soit arrivé(e)", "nous": "que nous soyons arrivé(e)s", "vous": "que vous soyez arrivé(e)(s)", "ils/elles": "qu'ils soient arrivé(e)s" },
    "subjonctif plus-que-parfait": { "je": "que je fusse arrivé(e)", "tu": "que tu fusses arrivé(e)", "il/elle": "qu'il fût arrivé(e)", "nous": "que nous fussions arrivé(e)s", "vous": "que vous fussiez arrivé(e)(s)", "ils/elles": "qu'ils fussent arrivé(e)s" },
    ...
    "conditionnel passé première forme": { "je": "serais arrivé(e)", "tu": "serais arrivé(e)", "il/elle": "serait arrivé(e)", "nous": "serions arrivé(e)s", "vous": "seriez arrivé(e)(s)", "ils/elles": "seraient arrivé(e)s" },
    "conditionnel passé deuxième forme": { "je": "fusse arrivé(e)", "tu": "fusses arrivé(e)", "il/elle": "fût arrivé(e)", "nous": "fussions arrivé(e)s", "vous": "fussiez arrivé(e)(s)", "ils/elles": "fussent arrivé(e)s" },
    "impératif présent": { "tu": "arrive", "nous": "arrivons", "vous": "arrivez" },
    "impératif passé": { "tu": "sois arrivé(e)", "nous": "soyons arrivé(e)s", "vous": "soyez arrivé(e)(s)" },
    "infinitif présent": "arriver",
    "infinitif passé": "être arrivé(e)",
    "participe présent": "arrivant",
    "participe passé": "arrivé",
    "gérondif présent": "en arrivant",
    "gérondif passé": "en étant arrivé(e)"
  }
};
